...
const PageInfo4 = ({navigation}) => {
  ...
  const Info_2 = {
    text: "       COVID-19 สามารถแพร่จากคนสู่คนและสัตว์สู่คน ผ่านทางละอองน้ำมูก น้ำลายจากจมูก หรือปาก ซึ่งออกมาขณะที่ผู้ติดเชื้อไอ จาม หรือพูด ทำให้ผู้ที่หายใจเอาละอองเหล่านี้เข้าไปติดเชื้อตามไปด้วย"
  }
  const Info_3 = {
    text: "       แต่ละอองเหล่านี้ลอยไปไม่ได้ไกล และตกลงสู่พื้นอย่างรวดเร็ว การรักษาระยะห่างจากผู้อื่นอย่างน้อย 1 เมตร และสวมใส่หน้ากากอนามัย จึงเป็นวิธีที่ช่วยป้องกัน COVID-19 ได้ในข้างต้น"
  }
  const Info_4={
    text:"       ละอองที่ตกลงสู่วัตถุ และพื้นผิวต่างๆ เช่น ราวบันได ลูกบิดประตู ก็สามารถทำให้ติดเชื้อ COVID-19 ได้ เมื่อเราเอามือไปจับพื้นผิวเหล่านั้น แล้วมาจับตา จมูก หรือปาก"
  }
  const Info_5={
  ...
  const Info_8={
    text:"       covid 19 มักมีอาการเบื้องต้นคล้ายไข้หวัด เช่น มีไข้ ไอแห้ง อ่อนเพลีย ทำให้หลายคนที่ไม่ได้มีอาการหนักอาจไม่ได้เข้ารับการรักษาที่เหมาะสม จนทำให้เกิดการแพร่ระบาดของโรค"
  }
