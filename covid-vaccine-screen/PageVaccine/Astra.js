...
const Astra = ({navigation}) => {
    ...
    const info_astra4 = "            4.ข้อมูลจาก AstraZeneca ระบุว่า มีน้อยกว่า 1% ที่มีอาการดังต่อไปนี้ ต่อมน้ำเหลืองโต เบื่ออาหาร มึนหรือเวียนหัว ปวดท้อง เหงื่อออกมากผิดปกติ มีผื่นคัน";
