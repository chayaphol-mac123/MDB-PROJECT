...
const Astra = ({navigation}) => {
    const info_astra1 = "            วัคซีนแต่ละตัวมีผลข้างเคียงที่แตกต่างกันออกไป บางตัวอาจส่งผลข้างเคียงต่อร่างกายมากในเข็มแรก ขณะที่บางตัวอาจส่งผลข้างเคียงต่อร่างกายมากกว่าในเข็มที่สอง แต่ผลข้างเคียงจากวัคซีนนี้จะแสดงอาการอยู่ประมาณ 1-2 วันเท่านั้น หลายประเทศอนุมัติให้ใช้วัคซีนของ AstraZeneca กับกลุ่มคนที่อายุมากกว่า 50 ปีขึ้นไป เนื่องด้วยรายงานเรื่องการพบลิ่มเลือดหลังฉีดวัคซีนดังกล่าว ซึ่งเสี่ยงจะเกิดกับเพศหญิงที่อายุต่ำกว่า 49 ปี ขณะที่ ข้อมูลจาก AstraZeneca ในไทยระบุว่า วัคซีนของ AstraZeneca ได้รับการอนุมัติใช้งานแล้วกว่า 168 ประเทศทั่วโลก และสามารถฉีดให้แก่ผู้มีอายุ 18 ปีขึ้นไปได้ ";
    const info_astra2 = "            วัคซีนของ AstraZeneca มีประสิทธิภาพอยู่ที่ประมาณ 70% โดย National Health Service (NHS) หรือระบบบริการสุขภาพแห่งชาติของสหราชอาณาจักร ระบุถึงอาการข้างเคียงระยะสั้นที่อาจพบได้หลังรับวัคซีน ดังนี้ ปวดหรือเจ็บบริเวณแขนข้างที่ได้รับวัคซีน ปวดหัว หรือปวดกล้ามเนื้อ ปวดตามข้อ หนาวสั่น คลื่นไส้ หรืออาเจียน เหนื่อยล้า ท้องเสีย มีไข้ (สูงกว่า 37.5°C)";
    const info_astra3 = "            ขณะที่ ข้อมูลจาก AstraZeneca ระบุถึงอาการข้างเคียงที่พบได้ทั่วไปว่า ประมาณ 60% มีอาการเจ็บบริเวณที่ฉีด 50% มีอาการปวดศรีษะและอ่อนเพลีย อีก 40% มีอาการปวดกล้ามเนื้อ ครั่นเนื้อครั่นตัว ส่วนอีก 30% มีอาการไข้ หนาวสั่น และอีก20% มีอาการปวดข้อและคลื่นไส้";
