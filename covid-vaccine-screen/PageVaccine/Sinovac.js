...
const Sinovac = ({}) => {
    ...
    const info_sinovac5 = "\t\t\tอาการไม่พึงประสงค์หลังฉีดวัคซีน จริงๆ แล้วพบได้ในการฉีดวัคซีนทุกชนิด แต่สำหรับวัคซีนโควิดน่าจะเป็นที่สนใจมากกว่าวัคซีนชนิดอื่นๆ เพราะเป็นวัคซีนใหม่กำลังเป็นที่จับตามมองนั่นเอง \n\n\t\t\tในประเทศไทย ปัจจุบัน (15 มีนาคม 2564) มีรายงานจำนวนผู้มีอาการไม่พึงประสงค์ (adverse reaction) จากการฉีดวัคซีนโควิดซิโนแวค ซึ่งไม่ใช่การแพ้วัคซีน (allergic reaction) ดังนี้ อาเจียน 17% ปวดเมื่อยเนื้อตัว 14% อักเสบบริเวณที่ฉีด 13% มีไข้ 11% \n\n\t\t\tนอกจากนั้นยังมีอาการปวดศีรษะ ท้องเสีย ผื่นขึ้น อ่อนเพลีย คลื่นไส้ มีอาการปวด บวมแดง บริเวณที่ฉีดวัคซีน ซึ่งกรมควบคุมโรคยืนยันว่า  เป็นอาการที่พบได้เป็นปกติหลังรับวัคซีน อาการดังกล่าวจะไม่รุนแรงและหายได้เองภายใน 1-2 วันหลังรับวัคซีน";
