...
const Moderna = ({navigation}) => {
        const info_morderna1 = "\t\t\t\t\t\tวัคซีนโควิดโมเดอร์นา (Moderna COVID-19 Vaccine) เป็นวัคซีนชนิด mRNA ซึ่งเป็นสารพันธุกรรมสังเคราะห์ขึ้นได้ในห้องปฎิบัติการ มีชื่อตามที่ศูนย์ควบคุมและป้องกันโรค​สหรัฐอเมริกา (Centers for disease control: CDC) ระบุไว้คือ mRNA-1273 วัคซีน Moderna เป็นวัคซีนที่คิดค้นโดยบริษัทผู้ผลิตยาสัญชาติอเมริกัน ชื่อบริษัทโมเดอร์นา \n\n\t\t\t\t\t\tถือเป็นวัคซีนตัวที่ 2 ที่รับอนุมัติตามมาตรการฉุกเฉินจากองค์การอาหารและยาสหรัฐ (Food and drug administration: FDA) ตั้งแต่วันที่ 18 ธันวาคม 2563";
        ...
        return(
            <ScrollView style={styles.bgpage}>
                <View style={styles.cardView}>
                    ...
                    <Text style={styles.description}>{info_morderna1}</Text>
                </View>
                <View style={styles.cardView}>
